...
| [koito](./stacks/koito) | [music.lkwplus.com](https://music.lkwplus.com) / [scrobble.lkwplus.com](https://scrobble.lkwplus.com) | 20005 / 20006 | Koito scrobble server + multi-scrobbler |
...
| [gpt-load](./stacks/gpt-load) | [gptload.lkwplus.com](https://gptload.lkwplus.com) | 20035 | GPT-Load AI API proxy (built-in SQLite) |
| [miyabi](./stacks/miyabi) | [miyabi.lkwplus.com](https://miyabi.lkwplus.com) | 20036 | Miyabi — 115 cloud + JavDB media library (built-in SQLite, password gate) |
...
| [dsh](./stacks/dsh) | [dsh.lkwplus.com](https://dsh.lkwplus.com) | arm 20003 | DeepSeek Harness — agent harness Web UI (built from the upstream npm package, uid 1002 / `agent`) |
